# Лабораторная работа №3. Underlay на основе IS-SI
...
Произвести настройку протокола IS-IS для обеспечения связности Underlay сети.

## Описание задачи

В поставленой задаче требуется произвести настройку протокола IS-IS для побеспечения IP связности Underlay сети в рамках CLOS архитектуры. 
...
- IS-IS - открытый протокол динамической маршрутизации с учетом состояния каналов (link-state), использующийся для поиска наилучших маршрутов с применением алгоритма 
...
В рамках учебной лабораторной среды на всех сетевых устройствах был настроен протокол IS-IS. 
...
**Таблица маршрутизации IS-IS на коммутаторе S1**

![S1](images/isis_S1.jpg)

**Таблица соседства IS-IS на коммутаторе S1**

![S1](images/neighbor_S1.jpg)

**Таблица маршрутизации IS-IS на коммутаторе S2**

![S1](images/isis_S2.jpg)

**Таблица соседства IS-IS на коммутаторе S2**

![S1](images/neighbor_S2.jpg)

**Таблица маршрутизации IS-IS на коммутаторе L1**

![S1](images/isis_L1.jpg)

**Таблица соседства IS-IS на коммутаторе L1**

![S1](images/neighbor_L1.jpg)

**Таблица маршрутизации IS-IS на коммутаторе L2**

![S1](images/isis_L2.jpg)

**Таблица соседства IS-IS на коммутаторе L2**

![S1](images/neighbor_L2.jpg)

**Таблица маршрутизации IS-IS на коммутаторе L3**

![S1](images/isis_L3.jpg)
...
Был настроен протокол IS-IS на рабочем стенде, собранного в соответствии с CLOS архитекрурой. Произведены испытания, показавшие наличие IP связности сетевых усторйств посредством
протокола IS-IS между уровнями Spine и Leaf, а так же конечными устройствами.